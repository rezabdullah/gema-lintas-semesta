		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row">
				<div class="col-lg-12 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
					...
					<p>
						Menjadi perusahaan expedisi yang handal dan berkualitas.
					</p>

					<h4 class="mt-3">MISI</h4>

					<p>
						Menjadikan Sumber Daya Manusia dan Pelanggan yang kami miliki merupakan keluarga besar yang tidak terpisahkan.
					</p>

					<h4 class="mt-3 mb-0">Lokasi Cabang</h4>
					...
					<ul>
						<li>
							...
							<div>
								<h5>Ambon</h5>
								<p>Jl. P. Latumahina No. 17, Ambon. Pic : Adyos Tlp 0911 310495</p>
							</div>
						</li>
						<li>
							<i class="bx bx-store-alt"></i>
							<div>
								<h5>Balikpapan</h5>
								<p>Villa Damai Permai Blok D5 No. 14, Balikpapan. Pic : Muhali Tlp 0542 7204 146</p>
							</div>
						</li>
						<li>
							<i class="bx bx-store-alt"></i>
							<div>
								<h5>Banda Aceh</h5>
								<p>Jl. Tengku Dianjung No. 160 Keudah, Banda Aceh. Tlp 0651 3181 4</p>
							</div>
						</li>
						<li>
							<i class="bx bx-store-alt"></i>
							<div>
								...
								<p>Jl. P. Tirtayasa No. 03 - A ( samping SMKN 5 ) Bandar Lampung. Pic : Ahmad Tlp 0853 8376 9333</p>
							</div>
						</li>
					</ul>
				</div>
