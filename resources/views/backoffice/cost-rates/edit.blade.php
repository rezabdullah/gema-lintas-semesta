        ...
        <div class="col-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cost-rates.update', $costRate->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                    ...
                                    <select class="form-control @error('partner_id') is-invalid @enderror" id="partner_id" name="partner_id">
                                        ...
                                        @if (count($partners) > 0)
                                            @foreach($partners as $index => $partner)
                                                <option value="{{ $partner->id }}" {{ $partner->id == $costRate->partner_id ? 'selected' : '' }}>{{ $partner->name ." (". $partner->code .")" }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select class="form-control @error('sender_province') is-invalid @enderror" id="sender_province" name="sender_province">
                                        ...
                                        @if (count($provinces) > 0)
                                            @foreach($provinces as $index => $province)
                                                <option value="{{ $province->id ."#". $province->name }}" {{ $province->name == $costRate->sender_province ? 'selected' : '' }}>{{ $province->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('sender_city') is-invalid @enderror" id="sender_city" name="sender_city">
                                        <option>{{ $costRate->sender_city }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('sender_sub_district') is-invalid @enderror" id="sender_sub_district" name="sender_sub_district">
                                        <option>{{ $costRate->sender_sub_district }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('destination_province') is-invalid @enderror" id="destination_province" name="destination_province">
                                        ...
                                        @if (count($provinces) > 0)
                                            @foreach($provinces as $index => $province)
                                                <option value="{{ $province->id ."#". $province->name }}" {{ $province->name == $costRate->destination_province ? 'selected' : '' }}>{{ $province->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('destination_city') is-invalid @enderror" id="destination_city" name="destination_city">
                                        <option>{{ $costRate->destination_city }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('destination_sub_district') is-invalid @enderror" id="destination_sub_district" name="destination_sub_district">
                                        <option>{{ $costRate->destination_sub_district }}</option>
                                    </select>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('weight') is-invalid @enderror" id="weight" name="weight" placeholder="1" value="{{ $costRate->weight }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ctg_type') is-invalid @enderror" id="ctg_type" name="ctg_type" placeholder="kg" value="{{ $costRate->ctg_type }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('cost') is-invalid @enderror" id="cost" name="cost" placeholder="20.000" value="{{  number_format($costRate->cost, 0, ".", ",") }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('cost-rates') }}" class="btn btn-default">Back</a>
                                </div>
                            </div>
                        </div> 
                    </form>
